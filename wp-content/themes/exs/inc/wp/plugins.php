...
if ( ! function_exists( 'exs_demo_import_lists' ) ) :
	function exs_demo_import_lists(){
		...
		$demo_lists = array(
			...
			'exs-church'         => array(
				'title'          => esc_html__( 'ExS Church', 'exs' ),
				'template_url'   => array(
					'content' => 'https://cdn.exsthemewp.com/demos-ai/church/content.json',
					'options' => 'https://cdn.exsthemewp.com/demos-ai/church/options.json',
					'widgets' => 'https://cdn.exsthemewp.com/demos-ai/church/widgets.json',
				),
				'screenshot_url' => 'https://exsthemewp.com/wp-content/uploads/2023/03/exs-church-fastest-wordpress-theme.png',
				'demo_url'       => 'https://demos2.exsthemewp.com/parent-church/',
				'type'           => 'gutenberg',
				'author'         => esc_html__( 'ExS', 'exs' ),
				'keywords'       => array( 'shop', 'ecommerce', 'woocommerce', 'events', 'church' ),
				'categories'     => array( 'ngo', 'events', 'religion' ),
				'plugins'        => array(
					array(
						'name' => esc_html__( 'ExS Widgets', 'exs' ),
						'slug' => 'exs-widgets',
			...
			'exs-armor'         => array(
				'title'          => esc_html__( 'ExS Armor', 'exs' ),
				'template_url'   => array(
					'content' => 'https://cdn.exsthemewp.com/demos-ai/armor/content.json',
					'options' => 'https://cdn.exsthemewp.com/demos-ai/armor/options.json',
					'widgets' => 'https://cdn.exsthemewp.com/demos-ai/armor/widgets.json',
				),
				'screenshot_url' => 'https://exsthemewp.com/wp-content/uploads/2023/07/screenshot-armor.png',
				'demo_url'       => 'https://demos2.exsthemewp.com/parent-armor/',
				'type'           => 'gutenberg',
				'author'         => esc_html__( 'ExS', 'exs' ),
				'keywords'       => array( 'shop', 'ecommerce', 'woocommerce', 'services', 'armor' ),
				'categories'     => array( 'ecommerce', 'business', 'services' ),
				'plugins'        => array(
					array(
						'name' => esc_html__( 'ExS Widgets', 'exs' ),
						'slug' => 'exs-widgets',
			...
			'exs-portfolio'         => array(
				'title'          => esc_html__( 'ExS Portfolio', 'exs' ),
				'template_url'   => array(
					'content' => 'https://cdn.exsthemewp.com/demos-ai/portfolio/content.json',
					'options' => 'https://cdn.exsthemewp.com/demos-ai/portfolio/options.json',
					'widgets' => 'https://cdn.exsthemewp.com/demos-ai/portfolio/widgets.json',
				),
				'screenshot_url' => 'https://exsthemewp.com/wp-content/uploads/2022/12/screenshot.png',
				'demo_url'       => 'https://demos2.exsthemewp.com/child-portfolio/',
				'type'           => 'gutenberg',
				'author'         => esc_html__( 'ExS', 'exs' ),
				'keywords'       => array( 'personal', 'portfolio', 'gallery' ),
				'categories'     => array( 'personal', 'portfolio', 'blog', 'photo' ),
				'plugins'        => array(
					array(
						'name' => esc_html__( 'ExS Widgets', 'exs' ),
						'slug' => 'exs-widgets',
			...
			'exs-fashion'         => array(
				'title'          => esc_html__( 'ExS Fashion', 'exs' ),
				'template_url'   => array(
					'content' => 'https://cdn.exsthemewp.com/demos-ai/fashion/content.json',
					'options' => 'https://cdn.exsthemewp.com/demos-ai/fashion/options.json',
					'widgets' => 'https://cdn.exsthemewp.com/demos-ai/fashion/widgets.json',
				),
				'screenshot_url' => 'https://exsthemewp.com/wp-content/uploads/2021/10/exs-fashion-fastest-wordpress-theme.png',
				'demo_url'       => 'https://demos.exsthemewp.com/parent-fashion/',
				'type'           => 'gutenberg',
				'author'         => esc_html__( 'ExS', 'exs' ),
				'keywords'       => array( 'shop', 'ecommerce', 'woocommerce', 'models', 'fashion' ),
				'categories'     => array( 'ecommerce', 'business', 'energy' ),
				'plugins'        => array(
					array(
						'name' => esc_html__( 'ExS Widgets', 'exs' ),
			...
			'exs-personal'         => array(
				'title'          => esc_html__( 'ExS Personal', 'exs' ),
				'template_url'   => array(
					'content' => 'https://cdn.exsthemewp.com/demos-ai/personal/content.json',
					'options' => 'https://cdn.exsthemewp.com/demos-ai/personal/options.json',
					'widgets' => 'https://cdn.exsthemewp.com/demos-ai/personal/widgets.json',
				),
				'screenshot_url' => 'https://exsthemewp.com/wp-content/uploads/2022/08/exs-personal-screenshot-small.png',
				'demo_url'       => 'https://demos2.exsthemewp.com/child-personal/',
				'type'           => 'gutenberg',
				'author'         => esc_html__( 'ExS', 'exs' ),
				'keywords'       => array( 'personal', 'portfolio', 'gallery' ),
				'categories'     => array( 'personal', 'portfolio', 'blog', 'photo' ),
