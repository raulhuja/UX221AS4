		...
		return apply_filters(
			...
			array(
				...
				*/
				...
				'logo_img_max_height'                                  => array(
					'type'    => 'slider',
					'section' => 'title_tagline',
					'label'   => esc_html__( 'Logo Image Maximum Height', 'exs' ),
					'default' => esc_html( exs_option( 'logo_img_max_height', '' ) ),
					'atts'        => array(
						'min'         => '20',
						'max'         => '150',
						'step'        => '1',
				...
				'overlay_blur'                            => array(
					'type'            => 'checkbox',
					'section'         => 'section_layout',
					'label'           => esc_html__( 'Blur content under modals overlay', 'exs' ),
					'description'     => esc_html__( 'Add blur effect to content under mobile and side menus and search modals', 'exs' ),
					'default'         => esc_html( exs_option( 'overlay_blur', false ) ),
				),
				...
				'enable_wp_global_styles'         => array(
					'type'            => 'checkbox',
					'section'         => 'section_layout',
					'label'           => esc_html__( 'Enable WP6.3+ Gutenberg Global CSS styles', 'exs' ),
					'description'     => esc_html__( 'Starting from WP version 6.3 WordPress prints STYLE tag closing HEADER tag with additional Gutenberg related extra styles. If you want to use some extended Gutenberg styles for duetones or grid block layout - check this checkbox', 'exs' ),
					'default'         => esc_html( exs_option( 'enable_wp_global_styles', false ) ),
				),
				///////////
				//buttons//
				///////////
				...
				'meta_reddit'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Reddit URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_reddit', '' ) ),
				),
				'meta_tiktok'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
				...
				'meta_social_email'                      => array(
					'type'        => 'checkbox',
					'section'     => 'section_meta',
					'label'       => esc_html__( 'Add an email icon to social links', 'exs' ),
					'description' => esc_html__( 'Will show an email envelop in the social links if checked', 'exs' ),
					'default'     => esc_html( exs_option( 'meta_social_email', '' ) ),
				),
				...
				'meta_custom_icons_heading'        => array(
					'type'        => 'block-heading',
					'section'     => 'section_meta',
					'label'       => esc_html__( 'Custom social icons', 'exs' ),
					'description' => esc_html__( 'Add your custom icon and URL to show custom icons into your social icons list.', 'exs' ),
				),
				//custom social button images - since 2.5.5
				'meta_custom_1_img'                           => array(
					'type'    => 'image',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 1', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_1_img', '' ) ),
				),
				'meta_custom_1_url'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 1 URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_1_url', '' ) ),
				),
				'meta_custom_1_title'                           => array(
					'type'    => 'text',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 1 title', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_1_title', '' ) ),
				),
				'meta_custom_2_img'                           => array(
					'type'    => 'image',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 2', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_2_img', '' ) ),
				),
				'meta_custom_2_url'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 2 URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_2_url', '' ) ),
				),
				'meta_custom_2_title'                           => array(
					'type'    => 'text',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 2 title', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_2_title', '' ) ),
				),
				'meta_custom_3_img'                           => array(
					'type'    => 'image',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 3', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_3_img', '' ) ),
				),
				'meta_custom_3_url'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 3 URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_3_url', '' ) ),
				),
				'meta_custom_3_title'                           => array(
					'type'    => 'text',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Custom Icon 3 title', 'exs' ),
					'default' => esc_html( exs_option( 'meta_custom_3_title', '' ) ),
				),
				...
				'header_image_disable_page_featured_image_override_background'              => array(
					'type'        => 'checkbox',
					'section'     => 'header_image',
					'label'       => esc_html__( 'Disable page featured image override background', 'exs' ),
					'description' => esc_html__( 'By default page featured image will override title background image if ste. Check this to prevent title section background overriding', 'exs' ),
					'default'     => esc_html( exs_option( 'header_image_disable_page_featured_image_override_background', false ) ),
				),
				...
				'menu_desktop'                    => array(
					...
					'choices' => array(
						...
						'11' => esc_html__( 'Full height hover background', 'exs' ),
					),
				),
				...
				'menu_mobile_overflow_hidden'              => array(
					'type'    => 'checkbox',
					'section' => 'section_top_nav',
					'label'   => esc_html__( 'Disable scroll when mobile menu is opened', 'exs' ),
					'default' => esc_html( exs_option( 'menu_mobile_overflow_hidden', false ) ),
				),
				...
				'title_disable_page_featured_image_override_background'              => array(
					'type'        => 'checkbox',
					'section'     => 'section_title',
					'label'       => esc_html__( 'Disable page featured image override background', 'exs' ),
					'description' => esc_html__( 'By default page featured image will override title background image if ste. Check this to prevent title section background overriding', 'exs' ),
					'default'     => esc_html( exs_option( 'title_disable_page_featured_image_override_background', false ) ),
				),
				...
				'footer_top_widgets_one_column'                          => array(
					'type'    => 'checkbox',
					'section' => 'section_footer_top',
					'label'   => esc_html__( 'Show widgets in one columnt', 'exs' ),
					'default' => esc_html( exs_option( 'footer_top_widgets_one_column', false ) ),
					'description' => esc_html__( 'If checked widgets will take full width.', 'exs' ),
				),
				...
				'blog_single_featured_image_show_caption'                        => array(
					'type'    => 'checkbox',
					'section' => 'section_blog_post',
					'label'   => esc_html__( 'Show featured image caption if set', 'exs' ),
					'default' => esc_html( exs_option( 'blog_single_featured_image_show_caption', '' ) ),
				),
				...
				'blog_single_read_progress_bar_percent_font_size'                       => array(
					'type'        => 'slider',
					'section'     => 'section_blog_post',
					'label'       => esc_html__( 'Reading time percentage font size', 'exs' ),
					'description' => esc_html__( 'Value in pixels. Leave blank to hide.', 'exs' ),
					'default'     => esc_html( exs_option( 'blog_single_read_progress_bar_percent_font_size', '' ) ),
					'atts'        => array(
						'min'         => '5',
						'max'         => '14',
						'step'        => '1',
				...
				'blog_single_read_progress_bar_percent_font_color'                      => array(
					'type'    => 'color-radio',
					'section' => 'section_blog_post',
					'label'   => esc_html__( 'Reading time percentage text color', 'exs' ),
					'default' => esc_html( exs_option( 'blog_single_read_progress_bar_percent_font_color', '' ) ),
					'description' => esc_html__( 'Set font size to take effect.', 'exs' ),
					'choices' => array(
						''                        => esc_html__( 'Inherit', 'exs' ),
						'l'                       => esc_html__( 'Light', 'exs' ),
						'l m'                     => esc_html__( 'Grey', 'exs' ),
				...
				'blog_single_read_progress_bar_percent_position'                       => array(
					'type'        => 'select',
					'section'     => 'section_blog_post',
					'label'       => esc_html__( 'Reading time percentage position', 'exs' ),
					'description' => esc_html__( 'Set font size to take effect.', 'exs' ),
					'default'     => esc_html( exs_option( 'blog_single_read_progress_bar_percent_position', '' ) ),
					'choices' => array(
						''       => esc_html__( 'Default', 'exs' ),
						'50%' => esc_html__( 'Center', 'exs' ),
						'100%'  => esc_html__( 'Right', 'exs' ),
					),
				),
				...
				'search_show_page_featured_image'          => array(
					'type'    => 'checkbox',
					'section' => 'section_search',
					'label'   => esc_html__( 'Show featured images for pages', 'exs' ),
					'default' => esc_html( exs_option( 'search_show_page_featured_image', false ) ),
				),
				...
				'404_hide_title_section'               => array(
					'type'    => 'checkbox',
					'section' => 'section_404',
					'label'   => esc_html__( 'Hide Title Section', 'exs' ),
					'default' => esc_html( exs_option( '404_hide_title_section', false ) ),
				),
				'404_heading'      => array(
					'type'    => 'text',
					'section' => 'section_404',
				...
				'404_fluid'                          => array(
					...
					'section' => 'section_404',
					'label'   => esc_html__( 'Full Width Section', 'exs' ),
					'default' => esc_html( exs_option( '404_fluid', false ) ),
				),
				'404_background'                     => array(
					'type'    => 'color-radio',
					'section' => 'section_404',
					'label'   => esc_html__( 'Background Color', 'exs' ),
					'default' => esc_html( exs_option( '404_background', '' ) ),
					'choices' => exs_customizer_backgrounds_array(),
				),
				'404_border_top'                     => array(
					'type'    => 'select',
					'section' => 'section_404',
					'label'   => esc_html__( 'Top border', 'exs' ),
					'default' => esc_html( exs_option( '404_border_top', '' ) ),
					'choices' => exs_customizer_borders_array(),
				),
				'404_border_bottom'                  => array(
					'type'    => 'select',
					'section' => 'section_404',
					'label'   => esc_html__( 'Bottom border', 'exs' ),
					'default' => esc_html( exs_option( '404_border_bottom', '' ) ),
					'choices' => exs_customizer_borders_array(),
				),
				'404_extra_padding_top'              => array(
					...
					'section' => 'section_404',
					'label'   => esc_html__( 'Top padding', 'exs' ),
					'default' => esc_html( exs_option( '404_extra_padding_top', '' ) ),
					'choices' => array(
						''      => esc_html__( 'Default', 'exs' ),
						'pt-0'  => esc_html__( '0', 'exs' ),
						'pt-1'  => esc_html__( '1em', 'exs' ),
				...
				'404_extra_padding_bottom'           => array(
					...
					'section' => 'section_404',
					'label'   => esc_html__( 'Bottom padding', 'exs' ),
					'default' => esc_html( exs_option( '404_extra_padding_bottom', '' ) ),
					'choices' => array(
						''      => esc_html__( 'Default', 'exs' ),
						'pb-0'  => esc_html__( '0', 'exs' ),
						'pb-1'  => esc_html__( '1em', 'exs' ),
				...
				'404_font_size'                      => array(
					'type'    => 'select',
					'section' => 'section_404',
					'label'   => esc_html__( 'Section font size', 'exs' ),
					'default' => esc_html( exs_option( '404_font_size', '' ) ),
					'choices' => exs_customizer_font_size_array(),
				),
				'404_background_image_heading'      => array(
					'type'        => 'block-heading',
					'section'     => 'section_404',
					'label'       => esc_html__( 'Background image settings', 'exs' ),
				),
				'404_background_image'               => array(
					'type'    => 'image',
					'section' => 'section_404',
					'label'   => esc_html__( 'Section Background Image', 'exs' ),
					'default' => esc_html( exs_option( '404_background_image', '' ) ),
				),
				'404_background_image_cover'         => array(
					'type'    => 'checkbox',
					'section' => 'section_404',
					'label'   => esc_html__( 'Cover background image', 'exs' ),
					'default' => esc_html( exs_option( '404_background_image_cover', false ) ),
				),
				'404_background_image_fixed'         => array(
					'type'    => 'checkbox',
					'section' => 'section_404',
					'label'   => esc_html__( 'Fixed background image', 'exs' ),
					'default' => esc_html( exs_option( '404_background_image_fixed', false ) ),
				),
				'404_background_image_overlay'       => array(
					'type'    => 'select',
					'section' => 'section_404',
					'label'   => esc_html__( 'Overlay for background image', 'exs' ),
					'default' => esc_html( exs_option( '404_background_image_overlay', '' ) ),
					'choices' => exs_customizer_background_overlay_array(),
				),
				'404_background_image_overlay_opacity' => array(
					'type'        => 'slider',
					'label'       => esc_html__( 'Overlay Opacity', 'exs' ),
					'default'     => esc_html( exs_option( '404_background_image_overlay_opacity', '' ) ),
					'section'     => 'section_404',
					'atts'        => array(
						'min'         => '1',
						'max'         => '99',
				...
				//since 2.5.3 - custom recipient for each form
				'contact_allow_custom'                        => array(
					'type'    => 'checkbox',
					'section' => 'section_contact_messages',
					'label'   => esc_html__( 'Allow different recipients for forms', 'exs' ),
					'description' => esc_html__( 'If checked, you can add a hidden input to your form with "to" attribute name and custom email address as a value. This will allow to send different forms to different emails.', 'exs' ),
					'default' => esc_html( exs_option( 'contact_allow_custom', false ) ),
				),
