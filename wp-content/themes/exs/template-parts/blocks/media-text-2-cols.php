	...
	<div class="wp-block-group__inner-container">
		...
		<div class="wp-block-media-text is-vertically-aligned-center" style="grid-template-columns:35% auto">
			...
			<div class="wp-block-media-text__content"><!-- wp:heading {"className":""} -->
				<h2 class=""><strong>Duis consequat</strong> augue id nisi iaculis non <strong>consequat justo</strong> ullamcorper</h2>
				<!-- /wp:heading -->
				...
				<div class="wp-block-buttons mt-2"><!-- wp:button {"className":""} -->
					...
					<div class="wp-block-button"><a
								class="wp-block-button__link has-main-background-color has-background" href="#">Montes Orci</a></div>
					<!-- /wp:button --></div>
				<!-- /wp:buttons --></div>
		</div>
		<!-- /wp:media-text --></div>
