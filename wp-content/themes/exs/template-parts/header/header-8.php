...
<div id="toplogo" class="toplogo <?php echo esc_attr( $exs_font_size . ' ' . $exs_header_toplogo_bg . ' ' . $exs_header_top_tall . ' ' . $exs_toplogo_hidden_class ); ?>">
	...
	?>
	<div class="container<?php echo esc_attr( $exs_fluid ); ?> container-md-flex pt-1 pb-1">
		<?php
			get_template_part( 'template-parts/header/logo/logo', exs_template_part( 'logo', '1' ) );
		?>
		<div class="<?php echo esc_attr( $exs_meta_hidden_class ); ?> icons-media flex-icons">
			<?php
...
<div id="header-affix-wrap" class="header-wrap <?php echo esc_attr( $exs_header_background . ' ' . $exs_transparent . ' ' . $exs_absolute ); ?>">
	...
	<header
		...
		class="header header-8 no-logo <?php echo esc_attr( $exs_header_background . ' ' . $exs_header_align_main_menu . ' ' . $exs_font_size . ' ' . $exs_sticky . ' ' . $exs_transparent . ' ' . $exs_absolute . ' ' . $exs_toggler_main_center ); ?>">
		<?php
