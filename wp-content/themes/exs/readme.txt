...
== Changelog ==
= 2.5.7, January 27, 2025 =
* WordPress 6.7 compatibility
+ PRO only - new theme skin
* PRO only - admin account page improvements
...
= 2.5.5, July 9, 2024 =
+ Add Customizer option to print WordPress Gutenberg block editor global styles in the header tag. Useful if you're using new grid layout blocks, duetones etc.
